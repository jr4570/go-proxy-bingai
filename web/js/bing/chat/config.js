...
_w['_sydConvConfig'] = {
  ...
  tigerEnhancedPromptTemplate:
    '搜索 {0}。用一個出色的回答給我留下深刻的印象，幫助我完成我最可能的意圖，同時展示你所能提供的智慧、深度和美感（加粗、表格和引用）。盡量在回答中儘早滿足我的意圖。 ',
  enableDlBing: false,
  // 不可滾動出聊天
...
_w['_sydConvTranslation'] = {
 actionBarPlaceholder: '有問題儘管問我...（Shift + Enter = 換行，"/" 觸發提示詞）',
  ...
  feedbackDislikeButtonAriaLabel: '取消點贊',
...
newTopicGreet12: '明白了，請繼續！感謝告訴我。我能提供什麼幫助？ ',
  ...
  newUserGreet: '嘿，你好！我是必應，除了簡單搜索之外，我還可以幫助你完成各種操作。你可以詢問我關於從家庭作業到歷史記錄到帽子的任何信息。你的想法是什麼？ ',
  newUserSugg1: '搜索運行狀況',
  newUserSugg2: '搜索電影',
  newUserSugg3: '創作歌曲',
  repeatUserGreet: '你好，你又回來了！很高興再次看到你。我今天能幫你做什麼？ ',
  repeatUserSugg1: '曲奇食譜',
  repeatUserSugg2: '你可以做什麼?',
  repeatUserSugg3: '告訴我一個事實',
  creativeGreet: '讓我們發揮創意吧！你是否在考慮某個主題，還是即興發揮？ ',
  balancedGreet: '很好，我還可以幫助你發現新事物並找到答案。我們首先應該做什麼？ ',
  preciseGreet: '你好，我來幫你查資料。首先請問我一個問題。 ',
  creativeSugg1: '告訴我一個關於小狗的故事',
  creativeSugg2: '給雷雨寫一封情書',
  creativeSugg3: '我可以為好友做些什麼？ ',
  ...
  sydneySapphireCopyToClipboardText: '已復製到剪貼板。 ',
  ...
  messageActionsCopying: '正在復制',
  messageActionsCopied: '已復制',
 ...
 serpfeedback: '反饋',
  ...
  notificationForbidden: '很抱歉，你似乎不再有權訪問此功能。請幾天后再次查看。 ',
  ...
  copyCodeSuccessToastTitle: '已復製到剪貼板',
  copyCodeButtonTooltip: '複製',
  copyCodeButtonSuccessTooltip: '已復制',
  ...
  threadsDelete: '刪除',
  threadsDescription: '你的必應 AI 支持的 copilot 現可自動保存聊天功能。可以從任何設備、桌面或移動設備訪問聊天，並無縫恢復。 ',
  ...
  zeroInputSuggestionFallback6: '創建一個表，幫助我計劃接下來兩週的就餐',
